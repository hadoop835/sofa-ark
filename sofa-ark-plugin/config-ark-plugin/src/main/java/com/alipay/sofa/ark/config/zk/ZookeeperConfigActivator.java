...
public class ZookeeperConfigActivator implements PluginActivator {
    ...
    public void stop(PluginContext context) {
        ...
        if (Objects.nonNull(this.ipCuratorCache)) {
            try {
                this.ipCuratorCache.close();
            } catch (Exception e) {
                // ignore
            }
        }
        if (Objects.nonNull(this.bizCuratorCache)) {
            try {
                this.bizCuratorCache.close();
            } catch (Exception e) {
                // ignore
            }
        }
